...
## 이미지 파일이 있는 경로
folder_path = 'C:/Users/User/Desktop/project4/my_face_exam'
txt_path = 'C:/Users/User/Desktop/project4/my_face_exam/labels'
...
for img_file in img_files :
    ...
    txt_file = os.path.join(txt_path, os.path.splitext(os.path.basename(img_file))[0] + '.txt')
